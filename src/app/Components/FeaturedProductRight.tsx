...
export default function FeaturedProductRight(props:{product:HeroImage}) {
  return (
...
<<<<<<< HEAD:src/app/Components/featured2.tsx
...
>>>>>>> work:src/app/Components/FeaturedProductRight.tsx
        </button>
      </div>
