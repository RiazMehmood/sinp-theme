...
import {SlSocialDribbble, SlSocialFacebook, SlSocialInstagram, SlSocialTwitter, SlSocialYoutube} from 'react-icons/sl' 
  ...
  return (
    <div className="flex flex-col items-center p-12 gap-5 bg-pink-50 rounded-lg shadow-md mx-auto ">
      ...
      <div className="flex flex-col md:flex-row mt-4">
        <input className="flex-grow w-full px-6 py-3 rounded-full md:rounded-r-none border border-black text-lg bg-pink-50" type="email" placeholder="email@example.com" />
        <button className="mt-2 md:mt-0 w-full md:w-auto px-4 py-3 rounded-full md:rounded-l-none bg-gray-800 text-white text-md font-semibold">Subscribe</button>
      </div>
