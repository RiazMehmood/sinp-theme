        ...
        {!isPlaying && (
          <div className='absolute inset-0' style={{backgroundImage: "url('/video-bg.webp')", zIndex:"10", backgroundSize: 'cover', backgroundPosition: 'center'}}>
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 z-20 flex flex-col gap-5 items-center justify-center space-y-4">
              <h2 className="md:text-4xl text-2xl mx-3 text-orange-500 font-bold text-center">The Right Headphones</h2>
              <h3 className="md:text-lg text-sm font-normal mx-3 text-white max-w-2xl text-center">In ornare quam viverra orci sagittis. Duis ultricies lacus sed turpis tincidunt id aliquet risus. Arcu felis bibendum ut tristique et</h3>
